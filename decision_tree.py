...
# training_data = [['1.0', '1.0', '1'], ['1.0', '2.0', '1'], ['2.0', '1.0', '1'], ['2.0', '2.0', '3'], ['3.0', '1.0', '1'], ['3.0', '2.0', '3'], ['3.0', '3.0', '3'], ['4.5', '3.0', '3']]

# Column labels.
# These are used only to print the tree.
# change these according to the needs of the data
...
class Question:
    ...
    def __init__(self, column, value1):
        self.column = column
        self.value = value1
